...
const { getCart, getDepartments, getAllPrinters, getCartModel, getCartriges, changePrinterModel, getAllDepartments, changePrinterDep, changeCartridgeModel, addPrinterModel, deletePrinterModel, deleteCartridgeModel, addCartridgeModel } = require("../../controllers/cart/cart");
